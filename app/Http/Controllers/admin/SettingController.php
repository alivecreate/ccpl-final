...
class SettingController extends Controller
{
    ...
    public function seoManageImageStore(Request $request)
    {
        ...
        if(count(WebsiteOption::get()) == 0){
           
            $websiteOptionLogo = new WebsiteOption;
            $websiteOptionLogo->option_name = 'logo';
            $websiteOptionLogo->option_value = $logo_name;
            $websiteOptionLogo->save();
           
            $websiteOptionFavicon = new WebsiteOption;
            $websiteOptionFavicon->option_name = 'favicon';
            $websiteOptionFavicon->option_value = $favicon_name;
            $websiteOptionFavicon->save();
