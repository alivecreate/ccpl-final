...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($isProduct)) {
            ...
            return redirect(url('admin') . '/photo?page=manage&main_category=' . $request->main_category . '&sub_category=' . $request->sub_category)->with('success', 'Product Details Updated...');
        } else {
