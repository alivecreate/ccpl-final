...
function change(){    
    ...
    //   if($('.light-bg-block').css('background') === 'https://www.w3schools.com/css/trolltunga.jpg'){
    //     $('.light-bg-block').css('background', 'https://www.w3schools.com/css/trolltunga.jpg');
    //     console.log($('.light-bg-block').css('background'));
    //   }
    //   else
    //   {
    //     console.log($('.light-bg-block').css('background'));
    //     $('.light-bg-block').css('background', 'http://hdwallpaperfun.com/wp-content/uploads/2015/07/Big-Waves-Fantasy-Image-HD.jpg');
    //   }

    //     $('light-bg-block').css('background', 'https://www.w3schools.com/css/trolltunga.jpg');

    //   if(img.background==="https://www.w3schools.com/css/trolltunga.jpg")         {
    //     img.background="http://hdwallpaperfun.com/wp-content/uploads/2015/07/Big-Waves-Fantasy-Image-HD.jpg";
    //   }    
    //   else
    //   {
    //       img.background="https://www.w3schools.com/css/trolltunga.jpg";
    //   }
}
