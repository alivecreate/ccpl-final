        ...
        <div class="col-xl-9 m-auto">
          <div class="invoice-wrapper">
            <div class="invoice-header">
              <img src="{{url('front')}}/images/invoice/bg4.jpg" class="img-fluid background-img" alt="">
              <div class="row">
            ...
            <div class="invoice-footer text-end">
              <div class="authorise-sign">
                <img src="{{url('front')}}/images/invoice/sign.png" class="img-fluid" alt="sing">
                <span class="line"></span>
                <h6>Authorised Sign</h6>
              </div>
              <div class="buttons">
                <a href="{{url('front')}}/" btn black-btn btn-solid rounded-2 me-2" onclick="window.print();">export as PDF</a>
                <a href="{{url('front')}}/" btn btn-solid rounded-2" onclick="window.print();">print</a>
              </div>
            </div>
          </div>
        </div>
