                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="page-title d-block">
                            <div class="title1 ">
                                <h2><a href="{{url('')}}/{{getParent($currentCategory->parent_id)['slug']}}/{{$currentCategory->slug}}/{{$product->slug}}">
                                {{$currentCategory->name}}</a></h2>
                            </div>
                        </div>
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
                                <a href="{{url('')}}/{{getParent($currentCategory->parent_id)['slug']}}">{{getParent($currentCategory->parent_id)['name']}}</a></li>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="top-banner-wrapper">
                                                    <a href="#">
                                                        ...
                                                        @endif
                                                        <div class="top-banner-content small-section my_top_content pb-1">
                                                        {!! html_entity_decode($currentCategory->description) !!}
                                                    </div>
                                                </div>
                                                <hr>
                                        ...
                                        <div class="tab-content-cls j-box style-box">
                                            ...
                                            <h5 class="p-3">{{$product->short_description}}</h5>
                                                <div class="text-center">
                                                    <a href="{{url('')}}/{{getParent($currentCategory->parent_id)['slug']}}/{{getParent($currentCategory->parent_id)['slug']}}/{{$product->slug}}" 
