                ...
                <div class="col-xl-9 m-auto">
                    <div class="invoice-wrapper">
                        <div class="invoice-header">
                            <img src="{{url('front')}}/images/invoice/bg3.jpg" class="background-invoice">
                            <img src="{{url('front')}}/images/icon/logo.png" class="img-fluid" alt="logo">
                        </div>
                        <div class="invoice-body">
                            ...
                            <div class="title-sec">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <a href="{{url('front')}}" btn black-btn btn-solid" onclick="window.print();">export as PDF</a>
                                    </div>
                                    <div class="col-6 text-end">
                                        <a href="{{url('front')}}" btn btn-solid" onclick="window.print();">print</a>
                                    </div>
                                </div>
                            </div>
                            <div class="table-sec">
                        ...
                        <div class="invoice-footer">
                            <img src="{{url('front')}}/images/invoice/shape.png" class="img-fluid design-shape" alt="">
                            <ul>
                                <li>
