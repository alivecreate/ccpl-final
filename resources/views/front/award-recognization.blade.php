...
$(document).ready(function () {
  ...
  // start fancybox:
    ...
    Fancybox.bind('[data-fancybox="zoom-gallery"]', {
  animated: false,
  showClass: false,
  hideClass: false,
...
<div class="parallax-layout parallax overlay header-award">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="page-title d-block">
                            <div class="title1 ">
                                <h2 class="title-inner1">AWARD RECOGNIZATION</h2>
                            </div>
                        </div>
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">AWARD RECOGNIZATION</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<section class="p-4 portfolio-section portfolio-padding grid-portfolio ratio2_3">
    <div class="container">
            <div align="center" id="form1">
                <button class="filter-button project_button active" data-filter="all">All</button>  
                @foreach($awards as $award)
                    <button class="filter-button project_button" data-filter="{{$award->id}}">{{$award->name}}</button>  
                @endforeach
            </div>
           
            <div class="row  zoom-gallery gallery">
            @foreach($awards as $award)
                @foreach(getMedia($award->id, 0 , 'award' ,'asc') as $image)
                        <div class="isotopeSelector filter {{$award->id}} col-lg-4 col-sm-6">
                        <div class="overlay">
                            <div class="border-portfolio">
                                <a href="{{url('web')}}/media/md/{{$image->image}}">
                                    <div class="overlay-background">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                                    </div>
                                    <img src="{{url('web')}}/media/md/{{$image->image}}"
