...
<section class="p-0 position-relative overflow-hidden">
    <div class="home-slider">
        <div class="product-slick-animated">
            <div>
                <div class="home">
                    <img src="{{url('front')}}/images/medicine/home-slider/1.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain product-detail">
                                    <div>
                                        <h1 class="animated font-cormorant" data-animation-in="fadeInUp" data-delay-in="0.2">Classic Ring</h1>
                                        <p class="animated d-lg-block d-none" data-animation-in="fadeInUp" data-delay-in="0.3">Lorem
                                        ...
                                        <a href="#" class="btn btn-solid animated" data-animation-in="fadeInUp" data-delay-in="0.6">add to cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home">
                    <img src="{{url('front')}}/images/medicine/home-slider/2.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain product-detail">
                                    <div>
                                        <h1 class="animated font-cormorant" data-animation-in="fadeInUp" data-delay-in="0.2">Pearl Necklace</h1>
                                        <p class="animated d-lg-block d-none" data-animation-in="fadeInUp" data-delay-in="0.3">Lorem
                                            Ipsum is simply dummy text of the printing and typesetting industry.
                                            Lorem Ipsum has been the industry's standard dummy text ever since the
                                            1500s, when an unknown printer</p>
            ...
            <div>
                <div class="home">
                    <img src="{{url('front')}}/images/medicine/home-slider/3.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain product-detail">
                                    <div>
                                        <h1 class="animated font-cormorant" data-animation-in="fadeInUp" data-delay-in="0.2">Blossom Earrings</h1>
                                        <p class="animated d-lg-block d-none" data-animation-in="fadeInUp" data-delay-in="0.3">Lorem
                                            Ipsum is simply dummy text of the printing and typesetting industry.
                                            Lorem Ipsum has been the industry's standard dummy text ever since the
                                            1500s, when an unknown printer</p>
        ...
        <div class="row thumbnail-porduct">
            <div class="col-lg-3 d-lg-block d-none m-auto">
                <div class="animated-nav">
                    <div><img src="{{url('front')}}/images/medicine/thumbnail/1.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                    <div><img src="{{url('front')}}/images/medicine/thumbnail/2.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                    <div><img src="{{url('front')}}/images/medicine/thumbnail/3.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col">
                <div class="slide-6 no-arrow">
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/mask.svg" alt=""></div>
                        </a>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/sugar-blood-level.svg" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>diabetic</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/eye-drops.svg" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>eye care</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/diet.svg" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>diet</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/holding-hands.svg" alt="">
                            </div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/cream.svg" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>skin care</h5>
                    ...
                    <div class="category-block">
                        <a href="#">
                            <div class="category-image"><img src="{{url('front')}}/svg/medical/drugs.svg" alt=""></div>
                        </a>
                        <div class="category-details">
                            <a href="#">
                                <h5>immunity</h5>
            ...
            <div class="col">
                <div class="theme-tab">
                    <ul class="tabs tab-title">
                        <li class="current">
                            <a href="tab-4">covid</a>
                        </li>
                        <li>
                            <a href="tab-5">personal care</a>
                        </li>
                        <li>
                            <a href="tab-6">diabetic</a>
                        </li>
                        <li>
                            <a href="tab-7">supplements</a>
                        </li>
                        <li>
                            <a href="tab-8">devices</a>
                        </li>
                    </ul>
                    <div class="tab-content-cls j-box style-box">
                        <div id="tab-4" class="tab-content active default">
                            <div class="no-slider row five-product margin-default">
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/1.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/3.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/4.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/5.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/6.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/7.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/8.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/9.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="{{url('front')}}/images/medicine/pro/10.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
        ...
        <div class="row partition3">
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-left text-start">
                        <div class="img-part">
                            <img src="{{url('front')}}/images/medicine/banner/11.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                        </div>
                        <div class="contain-banner">
                            <div>
                                <h4>save 30%</h4>
                                <h2 class="font-cormorant">gloves</h2>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-left text-start">
                        <div class="img-part">
                            <img src="{{url('front')}}/images/medicine/banner/12.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                        </div>
                        <div class="contain-banner">
                            <div>
                                <h4>save 60%</h4>
                                <h2 class="font-cormorant">oximeter</h2>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="row partition3">
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-left text-start">
                        <div class="img-part">
                            <img src="{{url('front')}}/images/medicine/banner/13.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h4>save 30%</h4>
                                <h2 class="font-cormorant">mask</h2>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-4">
                <a href="#">
                    <div class="collection-banner p-left text-start">
                        <div class="img-part">
                            <img src="{{url('front')}}/images/medicine/banner/14.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                        </div>
                        <div class="contain-banner banner-3">
                            <div>
                                <h4>save 60%</h4>
                                <h2 class="font-cormorant">pressure check</h2>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#">
                    <div class="collection-banner p-left text-start">
                        ...
                        <div class="contain-banner banner-3">
                            <div>
                                <h4>save 30%</h4>
                                <h2 class="font-cormorant">senetizer</h2>
                            </div>
                        </div>
                    </div>
                </a>
    ...
    <div class="container">
        <div class="row multiple-slider">
            <div class="col-lg-3 col-sm-6">
                <div class="collection-banner h-100 tl-content">
                    <div class="img-part h-100">
                        <img src="{{url('front')}}/images/medicine/banner/16.jpg" class="img-fluid bg-img" alt="">
                    </div>
                    <div class="contain-banner banner-3">
                        <div>
                            <h4 class="text-theme">save 30%</h4>
                            <h2 class="font-cormorant text-dark">equipment</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="theme-card">
                    ...
                    <div class="offer-slider slide-1">
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/1.jpg" alt=""></a>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/2.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/3.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
                        ...
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/4.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/5.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/6.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="collection-banner h-100 tl-content">
                    <div class="img-part h-100">
                        <img src="{{url('front')}}/images/medicine/banner/17.jpg" class="img-fluid bg-img" alt="">
                    </div>
                    <div class="contain-banner banner-3">
                        <div>
                            <h4 class="text-theme">save 30%</h4>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="theme-card">
                    ...
                    <div class="offer-slider slide-1">
                        <div>
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/7.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
                            ...
                            <div class="media">
                                <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload" src="{{url('front')}}/images/medicine/pro/8.jpg" alt=""></a>
                                <div class="media-body align-self-center">
                                    <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    <a href="product-page(no-sidebar).html">
                                        <h6>Slim Fit Cotton Shirt</h6>
                ...
                <div class="slide-3 no-arrow">
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="{{url('front')}}/images/medicine/blog/5.jpg" class="img-fluid blur-up lazyload bg-img">
                                    <span></span>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="{{url('front')}}/images/medicine/blog/6.jpg" class="img-fluid blur-up lazyload bg-img">
                                    <span></span>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="{{url('front')}}/images/medicine/blog/7.jpg" class="img-fluid blur-up lazyload bg-img">
                                    <span></span>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <div>
                                    <img alt="" src="{{url('front')}}/images/medicine/blog/8.jpg" class="img-fluid blur-up lazyload bg-img">
                                    <span></span>
                                </div>
                            </div>
                        </a>
