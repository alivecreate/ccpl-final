        ...
        <div class="col-xl-9 m-auto">
          <div class="invoice-wrapper">
            <div class="invoice-header">
              ...
              <img src="{{url('front')}}/images/invoice/bg.jpg" class="img-fluid background-img w-100" alt="background">
            </div>
            <div class="invoice-body">
              <ul class="date-detail">
                ...
                <li>
                  <span class="text-theme">issue date:</span>
                  <h4>20 March, 2020</h4>
                </li>
                <li>
                  <span class="text-theme">invoice no:</span>
                  <h4>908452</h4>
                </li>
                <li class="total-amount">
                  <span class="text-theme">$1090.00</span>
            ...
            <div class="invoice-footer pt-0">
              <div class="row">
                <div class="col-6">
                  <a href="{{url('front')}}" btn black-btn btn-solid rounded-2" onclick="window.print();">export as PDF</a>
                </div>
