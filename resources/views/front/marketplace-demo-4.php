                        ...
                        <div class="product-box product-wrap">
                            ...
                            <div class="product-detail">
                                ...
                                <ul class="image-swatch mb-0">
                                    <li><a href="#"><img src="../assets/images/fashion/pro/m-001.jpg" alt="" class="img-fluid"></a></li>
                                    <li><a href="#"><img src="../assets/images/fashion/pro/m-002.jpg" alt="" class="img-fluid"></a></li>
                                    <li><a href="#"><img src="../assets/images/fashion/pro/m-003.jpg" alt="" class="img-fluid"></a></li>
                                </ul>
                                <div class="progress-section">
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="h-100">
                        <img src="../assets/images/marketplace/banner/vertical2.jpg" class="img-fluid bg-img bg-top" alt="">
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="theme-card card-border bg-light border-0">
                            ...
                            <div class="offer-slider slide-1">
                                <div>
                                    <div class="media">
                                        <a href="product-page(no-sidebar).php"><img alt=""
        ...
        <div class="container">
            <div class="row section-b-space">
                <div class="col-lg-3 col-md-4 col-sm-5 col-6">
                    <div class="h-100">
                        <img src="../assets/images/marketplace/banner/vertical3.jpg" class="img-fluid bg-img bg-top" alt="">
                    </div>
                </div>
                    ...
                    <div class="marketplace-5 product-m no-arrow">
                        ...
                        <div class="product-box product-wrap">
                            ...
                            <div class="product-detail">
                                ...
                                <h4>$500.00</h4>
                                <ul class="image-swatch mb-0">
                                    <li><a href="#" tabindex="0"><img src="../assets/images/fashion/pro/m-001.jpg" alt="" class="img-fluid"></a></li>
                                    <li><a href="#" tabindex="0"><img src="../assets/images/fashion/pro/m-002.jpg" alt="" class="img-fluid"></a></li>
                                    <li><a href="#" tabindex="0"><img src="../assets/images/fashion/pro/m-003.jpg" alt="" class="img-fluid"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="product-box product-wrap">
