...
<div class="parallax-layout parallax overlay header-infrastructure">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="page-title d-block">
                            <div class="title1 ">
                                <h2 class="title-inner1">Infrastructures</h2>
                            </div>
                        </div>
...
<section class="p-4 about-page section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section"><img src="{{url('website')}}/about-banner.png" class="img-fluid blur-up lazyload" alt=""></div>
            </div>
            <div class="col-sm-12">
                <h4>
                    ...
                    <div>
                        <div class="media">
                            <div class="text-center">
                                <img src="{{url('website')}}/monil.png" alt="#">
                                <h5>Mr. Piyush Patel</h5>
