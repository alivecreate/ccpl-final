            ...
            <div class="col-lg-6">
                <div class="product-order">
                    <div class="row product-order-detail">
                        <div class="col-3"><img src="{{url('front')}}/images/pro3/27.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                    ...
                    <div class="row product-order-detail">
                        <div class="col-3"><img src="{{url('front')}}/images/pro3/35.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                        <div class="col-3 order_detail">
                            <div>
                                <h4>product name</h4>
                                <h5>cotton shirt</h5>
