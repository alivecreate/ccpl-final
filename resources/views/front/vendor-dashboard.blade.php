                             ...
                             <div class="row">
                                 <div class="col-md-4">
                                     <div class="counter-box">
                                         <img src="{{url('front')}}/images/icon/dashboard/order.png" class="img-fluid">
                                         <div>
                                             <h3>25</h3>
                                 ...
                                 <div class="col-md-4">
                                     <div class="counter-box">
                                         <img src="{{url('front')}}/images/icon/dashboard/sale.png" class="img-fluid">
                                         <div>
                                             <h3>12500</h3>
                                             <h5>total sales</h5>
                                         </div>
                                 ...
                                 <div class="col-md-4">
                                     <div class="counter-box">
                                         <img src="{{url('front')}}/images/icon/dashboard/homework.png" class="img-fluid">
                                         <div>
                                             <h3>50</h3>
                                             <h5>order pending</h5>
                                         </div>
                                 ...
                                 <div class="card dashboard-table">
                                     <div class="card-body">
                                         ...
                                         <table class="table mb-0">
                                             ...
                                             <tbody>
                                                 <tr>
                                                     <th scope="row"><img src="{{url('front')}}/images/dashboard/product/1.jpg" class="blur-up lazyloaded"></th>
                                                     <td>neck velvet dress</td>
                                                     <td>$205</td>
                                                     <td>1000</td>
                                                 </tr>
                                                 <tr>
                                                     <th scope="row"><img src="{{url('front')}}/images/dashboard/product/9.jpg" class="blur-up lazyloaded"></th>
                                                     <td>belted trench coat</td>
                                                     <td>$350</td>
                                                     <td>800</td>
                                                 </tr>
                                                 <tr>
                                                     <th scope="row"><img src="{{url('front')}}/images/pro3/34.jpg" class="blur-up lazyloaded"></th>
                                                     <td>man print tee</td>
                                                     <td>$150</td>
                                                     <td>750</td>
                                                 </tr>
                                     ...
                                     <div class="card-body table-responsive-md">
                                         ...
                                         <table class="table mb-0">
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr>
                                                     <th scope="row"><img src="{{url('front')}}/images/pro3/1.jpg" class="blur-up lazyloaded"></th>
                                                 ...
                                                 <tr>
                                                     <th scope="row"><img src="{{url('front')}}/images/pro3/27.jpg" class="blur-up lazyloaded"></th>
                                                     <td>men print tee</td>
                                                     <td>men clothes</td>
                                                     <td>$150</td>
                                                     <td>750</td>
                                                 ...
                                                 <tr>
                                                     <th scope="row"><img src="{{url('front')}}/images/pro3/36.jpg" class="blur-up lazyloaded"></th>
                                                     <td>men print tee</td>
                                                     <td>men clothes</td>
                                                     <td>$150</td>
                                                     <td>750</td>
 ...
 <!-- dare picker js -->
 <script src="{{url('front')}}/js/date-picker.js"></script>

 <!-- Bootstrap js-->
 <script src="{{url('front')}}/js/bootstrap.bundle.min.js"></script>

 <!-- chart js -->
 <script src="{{url('front')}}/js/chart/apex/apexcharts.js"></script>
 <script src="{{url('front')}}/js/chart/apex/custom-chart.js"></script>
