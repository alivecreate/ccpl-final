...
// dd(getWebsiteOptions()['website_logo']->option_value);
// $data = [
// 	'website_logo' =>  DB::table('website_options')->where('option_name', 'logo')->first(),
// 	'website_favicon' =>  DB::table('website_options')->where('option_name', 'favicon')->first(),
// ];
// dd($data['website_logo']->option_value);
// dd($pageData);
// dd($pageData['meta_description']);
?>
    <meta charset="utf-8">
...
@if(isset($pageData->image))
  ...
  <meta itemprop="image" content="{{url('web')}}/media/md/{{$pageData->image}}">
@elseif(isset($pageData['featured_image']))
  <meta itemprop="image" content="{{url('web')}}/media/md/{{$pageData['featured_image']}}">
@else
...
@if(isset($pageData['featured_image']))
  <meta property="og:image" content="{{url('web')}}/media/md/{{$pageData['featured_image']}}" />
@else
