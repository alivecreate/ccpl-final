...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="col text-center block">
                    <a href="{{route('admin.category')}}?type=main_category">
                  ...
                  <div class="col text-center block">
                    <a href="{{route('admin.category')}}?type=sub_category">
        ...
        <div class="row">
          <div class="col">
          <a href="{{route('setting.seo-manage')}}" class="text-info">
            <div class="info-box">
          ...
          <div class="col">
          <a href="{{route('customJs.create')}}"  class="text-success">
            <div class="info-box mb-3">
          ...
          <div class="col">
          <a href="{{route('topInflatable.create')}}" style="color:#932ab6;background:#932ab6">
            <div class="info-box mb-3">
              <span class="info-box-icon elevation-1" 
