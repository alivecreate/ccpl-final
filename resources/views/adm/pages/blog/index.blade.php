                    ...
                    <div class="form-check">
                        ...
                        <td width="150">
                          ...
                          <a href="{{route('blog.edit',$blog->id)}}" class="btn btn-sm btn-info float-left mr-2"  title="Edit Blogs"><i class="far fa-edit"></i></a>
                           <button class="btn btn-sm btn-danger del-modal float-left"  title="Delete Blog"  data-id="{{url('admin')}}/blog/{{$blog->id}}" data-title="{{ $blog->title}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                          </button>
