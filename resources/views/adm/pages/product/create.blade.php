        ...
        <div class="card-body">
          <div class="form-horizontal row">
            ...
            <div class="col-md-12">
              ...
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{route('product.store')}}">
                @csrf
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <input type="file" name="image" class="image " id="image" required accept="image/x-png,image/jpeg" />

                    <span >@error('image') {{$message}} @enderror</span>

                    <p >
                      Image size for should be( 400Px X 400Px ).<br>
