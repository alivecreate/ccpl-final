      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <a href="{{url('admin')}}/photo?page=manage&item_id={{$product->id}}" class="btn btn-dark btn-sm ml-2">
            <i class="fa fa-picture-o" aria-hidden="true"></i>
              &nbsp;&nbsp;Manage Photos ({{getMediaCount($product->id)}})</a>
        ...
        <div class="card-body">
          <div class="form-horizontal row">
            ...
            <div class="col-md-12">
              ...
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{route('product.update', $product->id)}}">
                @csrf
                @method('PUT')
                <div class="form-group row">
                  <div class="col-sm-4">
                    ...
                    <select name="category_parent_id" class="form-control category_parent_id">
                      ...
                      <option value="{{$parent_category->id}}" @if(isset(getParentCategory($product->category_id)['category']))
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Product Name" value="@if(old('name')){{old('name')}}@else{{$product->name}}@endif">
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="short_description" placeholder="Product Short Desctiption" value="@if(old('short_description')){{old('short_description')}}@else{{$product->short_description}}@endif">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="meta_title" placeholder="Seo Friendly Title" value="@if(old('meta_title')){{old('meta_title')}}@else{{$product->meta_title}}@endif">

                    <span class="text-danger">@error('meta_title') {{$message}} @enderror</span>
                  </div>
                  <div class="col-sm-12">
                    <label class="text-danger" for="meta_keyword">Keyword</label>
                    <input type="text" class="form-control" name="meta_keyword" placeholder="Seo Keywords with ," value="@if(old('meta_keyword')){{old('meta_keyword')}}@else{{$product->meta_keyword}}@endif">

                    <span class="text-danger">@error('meta_keyword') {{$message}} @enderror</span>
                  </div>
                  <div class="col-sm-12">
                    <label class="text-danger" for="meta_description">Description</label>
                    <textarea type="text" class="form-control" name="meta_description" placeholder="Seo Friendly Title">@if(old('meta_description')){{old('meta_description')}}@else{{$product->meta_description}}@endif</textarea>
              ...
              <div class="col-sm-6">
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control" name="slug" placeholder="Seo Friendly Url" value="@if(old('slug')){{old('slug')}}@else{{$product->slug}}@endif">
                ...
                <div class="form-group row">
                  <div class="col-sm-3">
                    ...
                    <input type="file" name="image" class="image " id="image" accept="image/x-png,image/jpeg" />
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="image_alt" placeholder="Image Alter Text (SEO)" value="@if(old('image_alt')){{old('image_alt')}}@else{{$product->image_alt}}@endif">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="image_title" placeholder="Product Image Title (SEO)" value="@if(old('image_title')){{old('image_title')}}@else{{$product->image_title}}@endif">

                    <span class="text-danger">@error('image_title') {{$message}} @enderror</span>
                  </div>
                
                <div class="col-sm-6">
                    <label class="text-danger" class="text-danger" for="search_index">Allow search engines to show?</label>
                    <select class="form-control" name="search_index">
                      <option value="1" @if($product->search_index == 1)
                        selected
                        @endif
                        >Yes</option>
                      <option value="0" @if($product->search_index == 0)
                        selected
                        @endif
                        >No</option>
                    </select>
                  ...
                  <div class="col-sm-6">
                    ...
                    <select class="form-control" name="search_follow">
                      <option value="1" @if($product->search_follow == 1)
                        selected
                        @endif
                        >Yes</option>
                      <option value="0" @if($product->search_follow == 0)
                        selected
                        @endif
                        >No</option>
                    </select>
                ...
                <div class="col-sm-12">
                  ...
                  <input type="text" class="form-control" name="canonical_url" placeholder="Canonical URL" value="@if(old('canonical_url')){{old('canonical_url')}}@else{{$product->canonical_url}}@endif">
