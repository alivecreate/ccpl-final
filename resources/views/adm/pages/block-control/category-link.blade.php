                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <div class="form-check">
                        ...
                        <h5 for="status"> <span class="badge badge-danger">Inactive</span></h5>@else<h5> <span class="badge badge-success">Active</span></h5>@endif</td>
                          ...
                          <td>
                          <a href="{{route('pageLink.create')}}?type=edit&id={{$pageLink->id}}" class="btn btn-xs btn-info float-left mr-2" title="Edit Category Link"><i class="far fa-edit"></i></a>
                          
                            <button class="btn btn-xs btn-danger del-modal float-left" title="Delete pageLink" data-id="{{$pageLink->id}}"
                             data-form="{{route('blockControl.delete')}}" data-title="{{ $pageLink->name}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                            </button>                      
                        </td>
                        </tr>
                      @endforeach
