                  ...
                  <table class="table table-hover">
                    ...
                    <div class="form-check">
                        ...
                        <h5 for="status"> <span class="badge badge-danger">Inactive</span></h5>@else<h5> <span class="badge badge-success">Active</span></h5>@endif</td>
                          ...
                          <a href="{{route('pageLink.create')}}?type=edit&id={{$pageLink->id}}" class="btn btn-xs btn-info float-left mr-2" title="Edit Page Link"><i class="far fa-edit"></i></a>
