...
$videoDetail = DB::table('products')->where('category_id', $sub_category)->first();
// dd($videoDetail);
?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <a href="{{route('video.edit',$video->id)}}" class="btn btn-primary btn-sm ml-2">
            <i class="far fa-edit"></i>
              &nbsp;&nbsp;Edit $video</a>
            
              <a href="{{url('')}}/{{getMainCategoryFromProduct($video->category_id)->slug}}/{{getSubCategoryFromProduct($video->category_id)->slug}}/{{$video->slug}}" class="btn btn-warning btn-sm ml-2">
            <i class="fa fa-eye"></i>
              &nbsp;&nbsp;View Video </a>
            ...
            <div class="col-md-12" style="
              ...
              <div class="form-group row">
                <form action="" class="col-sm-12 row">
                  ...
                  <label class="text-danger col-sm-12">Upload video Details</label>

                  <div class="col-sm-4">
                    <input type="text" class="form-control"
                      value="{{$video->name}}" readonly>
                ...
                <div class="row image-block col-sm-12 mb-3 p-0" style="position: relative;
                  ...
                  ">
                     ...
                     <input type="hidden" class="form-control"
                      value="{{$video->id}}" name="media_id">

                      <input type="hidden" class="form-control"
                      value="video" name="image_type">
