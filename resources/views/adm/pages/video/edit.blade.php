        ...
        <div class="card-body">
          <div class="form-horizontal row">
            ...
            <div class="col-md-12">
              ...
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{route('admin.video.update',$video->id)}}">
                @csrf
              ...
              <div class="col-sm-6">
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Name" value="{{$video->name}}" required>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    placeholder="Short Desctiption" value="{{$video->short_description}}">
                  ...
                  <div class="form-group row">
                      <div class="col-sm-12">
                        ...
                        <textarea id="summernote" name="full_description" placeholder="Award Recognization Descriptions" >{{$video->full_description}}</textarea>
...
<!--                   
                ...
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control" name="slug" placeholder="Seo Friendly Url" value="{{$video->slug}}" >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-12">
                    <label   for="meta_title">SEO Title</label>
                    <input type="text" class="form-control" name="meta_title" placeholder="Seo Friendly Title" value="{{$video->meta_title}}">
                    <span >@error('meta_title') {{$message}} @enderror</span>
                  </div>
                  <div class="col-sm-12">
                    <label  for="meta_keyword">Keyword</label>
                    <input type="text" class="form-control" name="meta_keyword" placeholder="Seo Keywords with ," value="{{$video->meta_keyword}}">
                    <span >@error('meta_keyword') {{$message}} @enderror</span>
                  </div>
                  <div class="col-sm-12">
                    <label  for="meta_description">Description</label>
                    <textarea type="text" class="form-control" name="meta_description" placeholder="Seo Friendly Title">{{$video->meta_description}}</textarea>
                    <span >@error('meta_description') {{$message}} @enderror</span>
                  </div>
                  </div>
                  <!-- <div class="col-sm-6">
