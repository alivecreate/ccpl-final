                  ...
                  <tbody  class="row_position">
                    ...
                    @foreach($parent_categories as $i => $parent_category)
                      ...
                      <tr id="{{$parent_category->id}}"> 
                        ...
                        @if(isset(getProductImageFromCategory($parent_category->id, 1)[0]->image))
                        <td><img class="rounded img-block"  width="150" 
                          src="{{asset('web')}}/media/sm/{{getProductImageFromCategory($parent_category->id, 1)[0]->image}}"/></td>
                          @else
                      ...
                      @endif
                        ...
                        @endif
                          ...
                          data-id="{{url('admin')}}/category/delete/{{ $parent_category->id}}" data-title="{{ $parent_category->name}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                                  </button>
                          </div>
                      </td>
                      </tr>
                      ...
                      <tr id="{{$sub_category->id}}"> 
                        ...
                        <td>
                            ...
                            @if($sub_category->image)
                              ...
                              <img class="rounded img-block m-1"  width="150" 
                                src="{{url('web')}}/media/sm/{{$sub_category->image}}"/>
                              @else
                          ...
                          @else
                            ...
                            src="{{url('adm')}}/img/no-item.jpeg"></td>
                          @endif
                        ...
                        <td><a href="{{route('product.create')}}?category_id={{$sub_category->id}}">Add Product</a></td>
                        <td>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input  pull-right" name="status" 
                        id="exampleCheck1"
                        ...
                        <div class="row">
                          <a class="btn btn-xs btn-info"
                           href="{{route('admin.category.edit',$sub_category->id)}}?type=sub_category&id={{getMainCategory($sub_category->parent_id)['mainCat']->id}}"><i class="far fa-edit"></i></a>
                              ...
                              <button type="button" class="btn btn-xs btn-danger del-modal"  title="Delete Category" 
                              data-id="{{url('admin')}}/category/delete/{{ $sub_category->id}}" data-title="{{ $sub_category->name}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                              </button>
                          </div>
                      </td>
                      </tr>
