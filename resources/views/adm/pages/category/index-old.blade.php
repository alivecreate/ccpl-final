                ...
                <table class="table table-hover text-nowrap">
                  ...
                  @foreach($parent_categories as $i => $parent_category)                  
                    <tr>
                      ...
                      &nbsp;&nbsp;&nbsp;
                              <button class="btn btn-xs btn-danger del-modal"  title="Delete Category"  data-id="{{url('admin')}}/category/delete/{{ $parent_category->id}}" data-title="{{ $parent_category->name}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                              </button>
                      ...
                      <td>
                        ...
                        <table class="table-border-none">
                          ...
                          <tr>
                            ...
                            &nbsp;&nbsp;&nbsp;
                              <button class="btn btn-xs btn-danger del-modal"  title="Delete Category"  data-id="{{url('admin')}}/category/delete/{{ $subCategory1->id}}" data-title="{{ $subCategory1->name}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                              </button>
                      ...
                      &nbsp;&nbsp;&nbsp;
                              <button class="btn btn-xs btn-danger del-modal"  title="Delete Category"  data-id="{{url('admin')}}/category/delete/{{ $subCategory2->id}}" data-title="{{ $subCategory2->name}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                              </button>
