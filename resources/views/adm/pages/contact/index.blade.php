            ...
            <div class="row">
                ...
                <div class="col-md-12 card card-info">
                    <div class="card-header">
                        <h3 class="card-title">ContactUs Lists</h3>
                    </div>
                    ...
                    <td>
                        <button class="btn btn-xs btn-danger del-modal float-left" title="Delete contactus" data-id="{{route('contactus.destroy', $contact->id)}}" data-title="{{ $contactus->full_name}}" data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                        </button>
                    </td>
                    </tr>
                    @endforeach
