...
$awardDetail = DB::table('products')->where('category_id', $sub_category)->first();
// dd($awardDetail);
?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <a href="{{route('award.edit',$award->id)}}" class="btn btn-primary btn-sm ml-2">
            <i class="far fa-edit"></i>
              &nbsp;&nbsp;Edit Award</a>
            
              <a href="{{url('')}}/{{getMainCategoryFromProduct($award->category_id)->slug}}/{{getSubCategoryFromProduct($award->category_id)->slug}}/{{$award->slug}}" class="btn btn-warning btn-sm ml-2">
            <i class="fa fa-eye"></i>
              &nbsp;&nbsp;View Award </a>
                ...
                <div class="row image-block col-sm-12 mb-3 p-0" style="position: relative;
                  ...
                  ">
                     ...
                     <input type="hidden" class="form-control"
                      value="{{$award->id}}" name="media_id">

                      <input type="hidden" class="form-control"
                      value="award" name="image_type">
