...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>ADD: New Award Recognization </h1>
        </div>
        ...
        <div class="card-body">
          <div class="form-horizontal row">
            ...
            <div class="col-md-12">
              ...
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{route('award.store')}}">
                @csrf
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    placeholder="Short Desctiption" value="{{old('short_description')}}">
                  ...
                  <div class="form-group row">
                      <div class="col-sm-12">
                        ...
                        <textarea id="summernote" name="full_description" placeholder="Award Recognization Descriptions" 
...
<!--                   
                ...
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control" name="slug" placeholder="Seo Friendly Url" value="{{old('slug')}}" >
