    ...
    <section class="content-header">
      ...
      <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb float-sm-right"><a href="{{route('criteria.meta.index')}}" class="btn btn-success btn-sm ml-2"><i class="fa fa-plus" aria-hidden="true"></i>
                  &nbsp;&nbsp;Add New Criteria </a>
                    ...
                    @foreach($criterias as $key => $criteria)
                      ...
                      <td>{{$criteria->item_no}}</td>
                        ...
                        <td>
                          ...
                          <button class="btn btn-xs btn-danger del-modal float-left"  title="Delete Criteria"  data-id="{{url('admin')}}/criteria/{{$criteria->id}}" 
