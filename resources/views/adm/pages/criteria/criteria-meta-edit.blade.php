          ...
          <div class="card-body">
            ...
            <div class="col-md-12 card card-info">
              ...
              <form method="post" enctype="multipart/form-data"  class="form-horizontal"
               action="{{route('criteria.meta.update')}}">
                @csrf
...
<!--                         
                        ...
                        <td>
                          ...
                          <a href="{{route('criteria.meta.edit',$criteriaMeta->id)}}" class="btn btn-xs btn-info float-left mr-2"  title="Edit Criteria"><i class="far fa-edit"></i></a>
                          ...
                          <button class="btn btn-xs btn-danger del-modal float-left"  title="Delete Criteria"  data-id="{{url('admin')}}/criteria/{{$criteriaMeta->id}}" 
