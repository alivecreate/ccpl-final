              ...
              <div class="card card-info">
                ...
                <form class="form-horizontal">
                  <div class="card-body p-2 pt-4">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <input type="descriotion" class="form-control" name="description" placeholder="Description">
                      </div>
                    </div>
                    <div class="form-group row">

                      <div class="col-sm-12">
                        <input type="file" class="" name="slider_img" placeholder="Slider Image" accept="image/png,image/jpeg">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-check">
                          <img src="https://mailvadodara.com/web/media/sm/1623500729_340.jpeg" width="100%" alt="" class="img-thumbnail">
                        </div>
                      </div>
                    </div>
                  </div>
